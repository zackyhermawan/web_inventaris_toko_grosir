                ...
                <div class="filter mb-3 d-flex justify-content-between">
                  <form method="GET" class="d-flex" role="search">
                      <div class="input-group" style="height: 7px">
                          <input type="text" name="search" value="<?php if (isset($_GET['search'])) {echo $_GET['search'];} ?>" class="search bg-white form-control rounded-start-5 border-0" placeholder="Search by name" aria-label="Search" aria-describedby="search-icon">
                          <span class="search bg-white input-group-text rounded-end-5 border-0" id="search-icon">
                          <button type="submit" class="border-0 bg-white btn-search"><i class="bi bi-search"></i></button>
                          </span>
                      </div>
                  </form>
