                              ...
                              <tr>
                                ...
                                <td>
                                  <div class='d-flex gap-2'>
                                    <a data-bs-toggle='modal' data-bs-target='#edit' class='fs-5 text-white d-flex align-items-center justify-content-center bg-primary rounded' style='width: 30px; height: 30px'
                                      ><i class='bi bi-pencil-square'></i
                                    ></a>
                                    <a data-bs-toggle='modal' data-bs-target='#delete' class='fs-5 text-white d-flex align-items-center justify-content-center bg-danger rounded' style='width: 30px; height: 30px'
